...
- `migrations/versions/` — 27 Alembic migrations (001–027; **016** = Phase B.1 datasets/ingest_jobs; **023** = Phase D memo_type/ontology_uri columns + feedback table; **024** = refine_jobs table; **025** = Phase F memories.distill_provenance + 'distill' audit op; **026** = memo_versions SCD-2 shadow for graph-node properties; **027** = forget_certificates table — Merkle-rooted, ed25519-signed proof-of-erasure)
